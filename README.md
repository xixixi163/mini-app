...
链接：https://juejin.cn/post/7353504333999505408?searchId=202411022139007434BD8189476AC42B3B#heading-35

#### lint-staged，husky

1、安装：`pnpm add husky lint-staged -D`
2、启用husky，会自动在package中增加script命令：`npx husky install`,提示：install command is DEPRECATED，原因：husky v9.0.1 现在从 husky install 更改为 husky init。链接：https://github.com/code100x/cms/issues/630
3、在package.json 中添加以下代码
